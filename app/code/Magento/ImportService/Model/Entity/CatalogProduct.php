 ...
 * @since 100.0.2
 */
class CatalogProduct extends \Magento\ImportService\Model\Entity\AbstractEntity
{
    ...
    protected $_fieldsMap = [
        ...
        \Magento\CatalogImportExport\Model\Import\Product::COL_STORE => 'store_view_code',
        \Magento\CatalogImportExport\Model\Import\Product::COL_ATTR_SET => 'attribute_set_code',
        \Magento\CatalogImportExport\Model\Import\Product::COL_TYPE => 'product_type',
        \Magento\CatalogImportExport\Model\Import\Product::COL_PRODUCT_WEBSITES => 'product_websites',
     ...
     * @param \Magento\CatalogImportExport\Model\Import\Product\Proxy\Product\ResourceModelFactory $resourceFactory
     * @param \Magento\CatalogImportExport\Model\Import\Product\Product\OptionFactory $optionFactory
     ...
     * @param \Magento\CatalogImportExport\Model\Import\Product\Proxy\ProductFactory $proxyProdFactory
     ...
     * @return $this
     */
    public function setParameters(ImportParamsInterface $params)
    {
